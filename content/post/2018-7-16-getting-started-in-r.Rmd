...
Edit: Up until earlier this year (spring 2019), I would often point people towards DataCamp, having found it useful personally. However, the company's handling of a sexual assault against one of their employees was really disappointing and has pushed me away from recommending them. You can read some responses to this issue from some former instructors [here](https://juliasilge.com/blog/datacamp-misconduct/) (Julia Silge) and [here](https://www.noamross.net/2019/04/12/datacamp-sexual-assault/) (Noam Ross). In lieu of DataCamp, [Codeacademy's *Learn R* course](https://www.codecademy.com/learn/learn-r) might be a reasonable alternative. Codeacademy also offers a virtual terminal setup, where you'll work through guided lessons to build fundamentals in the language.

...
<!-- on a plane, no wifi: do I have precision/recall backwards?? -->
- Also known as "precision", this metric represents the proportion of positive cases that were correctly predicted.

Specificity = D / (B + D)

- Also known as "recall", this metric represents the proportion of negative cases that were correctly predicted.

Balanced Accuracy = mean(Sensitivity, Specificity)

- This is merely an average of sensitivity and specificity.

Kappa = ... I'm on a plane rn, and can't remember how the formula is specified :(

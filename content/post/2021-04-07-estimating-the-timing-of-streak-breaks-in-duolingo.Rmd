...
```{r updates}
updates <- tibble(date = as.Date(mdy("8/31/20"):mdy("8/17/21"), origin = "1970-1-1")) %>%
  left_join(
    tibble(
      date   = mdy(c("10/1/20", "10/4/20", "10/15/20", "10/18/20", "10/20/20", "10/21/20", "10/25/20", "11/3/20", "11/25/20", "12/23/20", "12/25/20", "1/1/21", "1/2/21", "1/12/21", "1/17/21", "1/19/21", "1/27/21", "2/7/21", "2/16/21", "2/20/21", "2/23/21", "2/25/21", "3/4/21", "3/12/21", "3/14/21", "4/14/21", "5/3/21", "5/10/21", "5/22/21", "5/25/21", "6/1/21", "6/4/21", "6/11/21", "6/28/21", "7/14/21", "7/16/21", "7/17/21", "7/19/21", "7/21/21", "7/26/21")),
      freeze = 1L
    ),
    by = "date"
  ) %>%

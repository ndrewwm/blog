...
\begin{center}
\textbf{Andrew W. Moore} \break
Data Science Professional \& Developer \textbf{in} Boise, ID \break
\href{mailto:moore.andrew09@gmail.com}{moore.andrew09@gmail.com} \break
\url{https://semidocumentedlife.com/} \break
github: \href{https://github.com/mooreaw/}{@mooreaw} \break
\end{center}
...
\textbf{\underline{Professional Experience}}

`Jan 2020 to present`\newline
**Boise State University, Office of Institutional Research** | Research Analyst

- Develops analysis and ETL code used to support state & federal reporting obligations.

- Maintains and updates office Tableau dashboards each academic term.

- Responds to ad-hoc data requests, and creates & edits project documentation. \newline
...
\textbf{\underline{Community Engagement}}
...
\textbf{\underline{Talks \& Posters}}

- **Moore, A.** (2019) An overview of *tidytext*: exploring the October primary debate transcript. Invited presentation at the November meeting of the Ann Arbor R User Group.

- **Moore, A.** (2017) Building bivariate choropleths with leaflet and tidycensus: an illustration using NUFORC data. Invited presentation at the October meeting of the Ann Arbor R User Group.

- **Moore, A.** (2017) Citations in R-Markdown. Invited presentation at the June meeting of the Ann Arbor R User Group.
